  ...
  return (
    <>
      <div className="relative flex flex-col justify-end items-center w-full h-full bg-cover bg-no-repeat z-50">
        <motion.div {... fade(2)} className="w-full flex flex-col items-center absolute left-1/2 -translate-x-1/2 top-[10%]">
        ...
        <motion.div {... fade(3)} className="font-bold my-[5%] text-[5cqw] w-[23%] relative -left-[6%] whitespace-nowrap">
